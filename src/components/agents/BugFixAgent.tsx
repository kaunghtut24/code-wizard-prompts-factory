...
import { Bug, Search, CheckCircle, AlertTriangle, FileText, Edit } from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Bug Fix Agent</CardTitle>
            </div>
            <div className="flex items-center gap-2">
              <Badge variant={promptService.hasCustomPrompt('bug-fix') ? "default" : "secondary"} className="text-xs">
                {promptService.hasCustomPrompt('bug-fix') ? "Custom" : "Default"}
              </Badge>
              <Button
                variant="outline"
                size="sm"
