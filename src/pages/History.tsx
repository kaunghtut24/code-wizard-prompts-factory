...
const History: React.FC = () => {
  ...
  const loadConversations = async () => {
    try {
      ...
      console.log('History page loaded conversations:', allConversations.length);
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-semibold text-foreground">Conversation History</h1>
          ...
          {selectedConversation ? (
            <>
              <div className="p-4 border-b flex-shrink-0">
                <h3 className="font-medium text-foreground">Conversation Details</h3>
                <p className="text-sm text-muted-foreground">
